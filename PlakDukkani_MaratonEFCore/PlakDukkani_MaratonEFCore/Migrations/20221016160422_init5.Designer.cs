...
namespace PlakDukkani_MaratonEFCore.Migrations
{
    ...
    [Migration("20221016160422_init5")]
    partial class init5
    {
            ...
            modelBuilder.Entity("PlakDukkani_MaratonEFCore.DAL.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtistId = 1,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(5988),
                            DevamDurumu = true,
                            Fiyati = 223.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 2,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(6003),
                            DevamDurumu = false,
                            Fiyati = 172.00m,
                            IndirimOrani = 0.5m
                        },
                        new
                        {
                            ...
                            ArtistId = 3,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(6005),
                            DevamDurumu = false,
                            Fiyati = 369.60m,
                            IndirimOrani = 0.75m
                        },
                        new
                        {
                            ...
                            ArtistId = 4,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(6006),
                            DevamDurumu = false,
                            Fiyati = 175.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(6008),
                            DevamDurumu = true,
                            Fiyati = 22.50m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 16, 19, 4, 22, 143, DateTimeKind.Local).AddTicks(6009),
                            DevamDurumu = true,
                            Fiyati = 14.90m,
                            IndirimOrani = 0m
                        });
