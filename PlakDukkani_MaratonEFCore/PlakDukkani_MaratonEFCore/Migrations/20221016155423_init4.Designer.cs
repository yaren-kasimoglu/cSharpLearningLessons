...
namespace PlakDukkani_MaratonEFCore.Migrations
{
    ...
    [Migration("20221016155423_init4")]
    partial class init4
    {
            ...
            modelBuilder.Entity("PlakDukkani_MaratonEFCore.DAL.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtistId = 1,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6938),
                            DevamDurumu = true,
                            Fiyati = 223.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 2,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6953),
                            DevamDurumu = false,
                            Fiyati = 172.00m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 3,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6954),
                            DevamDurumu = false,
                            Fiyati = 369.60m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 4,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6955),
                            DevamDurumu = false,
                            Fiyati = 175.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6956),
                            DevamDurumu = true,
                            Fiyati = 22.50m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 54, 23, 439, DateTimeKind.Local).AddTicks(6957),
                            DevamDurumu = true,
                            Fiyati = 14.90m,
                            IndirimOrani = 0m
                        });
