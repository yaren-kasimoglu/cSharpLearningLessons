...
namespace PlakDukkani_MaratonEFCore.Migrations
{
    ...
    [Migration("20221017201428_init7")]
    partial class init7
    {
            ...
            modelBuilder.Entity("PlakDukkani_MaratonEFCore.DAL.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtistId = 1,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7960),
                            DevamDurumu = true,
                            Fiyati = 223.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 2,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7976),
                            DevamDurumu = false,
                            Fiyati = 172.00m,
                            IndirimOrani = 0.5m
                        },
                        new
                        {
                            ...
                            ArtistId = 3,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7978),
                            DevamDurumu = false,
                            Fiyati = 369.60m,
                            IndirimOrani = 0.75m
                        },
                        new
                        {
                            ...
                            ArtistId = 4,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7979),
                            DevamDurumu = false,
                            Fiyati = 175.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7980),
                            DevamDurumu = true,
                            Fiyati = 22.50m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 5,
                            CikisTarihi = new DateTime(2022, 10, 17, 23, 14, 28, 619, DateTimeKind.Local).AddTicks(7981),
                            DevamDurumu = true,
                            Fiyati = 14.90m,
                            IndirimOrani = 0m
                        });
