...
namespace PlakDukkani_MaratonEFCore.Migrations
{
    ...
    [Migration("20221016153004_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("PlakDukkani_MaratonEFCore.DAL.Entities.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtistId = 1,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 30, 4, 460, DateTimeKind.Local).AddTicks(6953),
                            DevamDurumu = true,
                            Fiyati = 223.20m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 2,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 30, 4, 460, DateTimeKind.Local).AddTicks(6968),
                            DevamDurumu = true,
                            Fiyati = 172.00m,
                            IndirimOrani = 0m
                        },
                        new
                        {
                            ...
                            ArtistId = 3,
                            CikisTarihi = new DateTime(2022, 10, 16, 18, 30, 4, 460, DateTimeKind.Local).AddTicks(6970),
                            DevamDurumu = true,
                            Fiyati = 369.60m,
                            IndirimOrani = 0m
                        });
